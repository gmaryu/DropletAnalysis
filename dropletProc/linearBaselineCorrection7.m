function [tracks,mean_ctv]=linearBaselineCorrection7(tracks, osci_table,colNames,tentative_trough_frames)
...
Description of function
    ...
    Corrected signal values are also normalized with a mean value of 1st trough value of all droplets.
...
%}
    ...
    if length(colNames)==1 
        ...
        for n =1:size(tracks)
            ...
            %%
            if sum(nuc) < 10 && length(trough_v)~=0
